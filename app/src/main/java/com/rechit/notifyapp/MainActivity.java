...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION = "com.rechit.notifyapp.ACTION_UPDATE_NOTIFICATION";
    private static final String ACTION_CANCEL_NOTIFICATION = "com.rechit.notifyapp.ACTION_CANCEL_NOTIFICATION";
    ...
    private class NotificationReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action){
                case ACTION_UPDATE_NOTIFICATION: //kalau action untuk cancel
                    updateNotification();
                    break;
